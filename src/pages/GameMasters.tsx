...
export default function GameMasters() {
  ...
  const [imageUrl, setImageUrl] = useState(() => {
    return localStorage.getItem("rfr_gamemasters_image") || defaultImage;
  });
  ...
  const handleTextSave = (e: React.FormEvent) => {
    ...
    localStorage.setItem("rfr_gamemasters_text", editText.trim());
    ...
    reader.onload = async (event) => {
      ...
      try {
        ...
        if (data.success && data.url) {
          ...
          localStorage.setItem("rfr_gamemasters_image", data.url);
        } else {
              ...
              <form onSubmit={handleTextSave} className="flex flex-col gap-4 text-left font-body">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Skriv text om spelledarna här..."
                    required
                  />
                </div>
              ...
              <form
                onSubmit={e => {
                  ...
                  if (editingHeaderField.value.trim()) {
                    ...
                    localStorage.setItem("rfr_gamemasters_header", JSON.stringify(updated));
